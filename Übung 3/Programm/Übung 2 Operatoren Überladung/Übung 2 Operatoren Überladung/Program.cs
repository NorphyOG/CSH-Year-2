                ...
                switch (wahl)
                    {
                        ...
                        case 'p':
                            ...
                            break;
                        case '+':
                            Bruch bruchPlus = new Bruch();
                            bruchPlus = bruch[0] + bruch[1];
                            Console.WriteLine(bruchPlus.Print());
                            break;
                        case '-':
                            Bruch bruchMinus = new Bruch();
                            bruchMinus = bruch[0] - bruch[1];
                            Console.WriteLine(bruchMinus.Print());                            
                            break;
                        case '*':
                            Bruch bruchMulti = new Bruch();
                            bruchMulti = bruch[0] * bruch[1];
                            Console.WriteLine(bruchMulti.Print());                             
                            break;
                        case '/':
                            Bruch bruchDiv = new Bruch();
                            bruchDiv = bruch[0] / bruch[1];
                            Console.WriteLine(bruchDiv.Print());                               
                            break;
                        case 't':
                            bruch[0] = bruch[3];
                            bruch[1] = bruch[2];
